...
# Batch compiles all benchmarks in verbose mode using C JOOS compiler.
#
...
------------
EOF
$JOOSC $OPTIONS $BENCHDIR/Fall99-base/02Benchmark/*.j[oa]*[sa] >> \
$DIR_PATH/$OUT
echo ' done'
...
------------
EOF
	$JOOSC $OPTIONS $BENCHDIR/Fall99-base/${i}Benchmark/*.j[oa]*[sa] >> \
	$DIR_PATH/$OUT
	echo ' done'
done
...
------------
EOF
	$JOOSC $OPTIONS $BENCHDIR/Winter99-base/$i/*.j[oa]*[sa] >> \
	$DIR_PATH/$OUT
	echo ' done'
done
...
# skip index.html
for i in `ls -I index.html $BENCHDIR/Progs-base/`
do
...
------------
EOF
	$JOOSC $OPTIONS $BENCHDIR/Progs-base/${i}/*.j[oa]*[sa] >> \
	$DIR_PATH/$OUT
	echo ' done'
done
