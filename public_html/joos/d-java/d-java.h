...
#include <stdio.h>
#include <stdlib.h>  /* LJH - added this one */
#include <string.h>
...
/**** LJH *****/
#define size_t int  /* used in two files, seems that int should be ok */
#define SEEK_CUR 1  /* used in fseek, not defined in SUN OS */
...
#define ERR_UNDEFINED_CONSTANT	6
#define ERR_READ	7
#define ERR_MEM		8
#define ERR_FIELD_TYPE	9
#define ERR_UNDEFINED_OPCODE	10
#define ERR_NO_BB	11
...
extern int totalbytes; /* LJH added */
