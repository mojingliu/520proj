...
public final class ANotUnaryExpNotMinus extends PUnaryExpNotMinus
{
    private TNot _not_;
    private PUnaryExp _unaryExp_;

    public ANotUnaryExpNotMinus()
    {
    }
    ...
    public Object clone()
    {
        return new ANotUnaryExpNotMinus(
    ...
    {
        ((Analysis) sw).caseANotUnaryExpNotMinus(this);
    }
