...
public class Lexer
{
    ...
    Token new6(@SuppressWarnings("hiding") String text, @SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TPow(text, line, pos); }
    ...
    Token new12(@SuppressWarnings("hiding") String text, @SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TId(text, line, pos); }
...
/*  {
        { // INITIAL
            {{9, 9, 1}, {10, 10, 2}, {13, 13, 3}, {32, 32, 4}, {37, 37, 5}, {40, 40, 6}, {41, 41, 7}, {42, 42, 8}, {43, 43, 9}, {45, 45, 10}, {47, 47, 11}, {48, 48, 12}, {49, 57, 13}, {65, 90, 14}, {95, 95, 15}, {97, 97, 16}, {98, 122, 17}, },
            {},
            {},
            {{10, 10, 18}, },
            {},
            ...
            {},
            {{48, 57, 20}, },
            {{48, 57, 21}, {65, 90, 22}, {95, 95, 23}, {97, 122, 24}, },
            {{48, 122, -16}, },
            {{48, 95, -16}, {97, 97, 24}, {98, 98, 25}, {99, 122, 24}, },
            {{48, 122, -16}, },
            {},
            {},
            {{48, 57, 20}, },
            ...
            {{48, 122, -16}, },
            {{48, 122, -16}, },
            {{48, 95, -16}, {97, 114, 24}, {115, 115, 26}, {116, 122, 24}, },
            {{48, 122, -16}, },
        }
    };*/
...
/*  {
        // INITIAL
        {-1, 1, 0, 0, 1, 4, 9, 10, 2, 7, 8, 3, 11, 11, 12, 12, 12, 12, 0, 6, 11, 12, 12, 12, 12, 12, 5, },
